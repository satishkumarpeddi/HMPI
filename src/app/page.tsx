              ...
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
                  <div className="flex items-center gap-3 text-left">
                    ...
                    <div>
                      <Label htmlFor="ai-switch" className="font-bold">
                        AI Missing Value Imputation
                      </Label>
                      <p className="text-sm text-muted-foreground">
                        Use AI to fill in missing data points for more accurate
                        analysis.
                      </p>
                    </div>
                  </div>
                  <Switch
                    id="ai-switch"
                    checked={useAiImputation}
                    onCheckedChange={setUseAiImputation}
                  />
                </div>
              </CardContent>
            </Card>
          ...
          return (
            <div className="flex flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="text-muted-foreground">
                Our AI is mapping columns and processing your file. This may
                take a moment.
              </p>
            </div>
          );
