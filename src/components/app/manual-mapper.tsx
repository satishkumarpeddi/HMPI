    ...
    return (
        <Card className="w-full max-w-lg">
            <CardHeader>
                ...
                <CardDescription>
                    We couldn't automatically detect the latitude and longitude columns. Please map them below to continue.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                <Alert variant="default" className="bg-primary/10 border-primary/50 text-primary-foreground">
                  <AlertCircle className="h-4 w-4 !text-primary" />
                  <AlertTitle className="text-primary font-semibold">Heads up!</AlertTitle>
                  <AlertDescription className="text-primary/90">
                    For best results, ensure your CSV headers are clearly named (e.g., "Latitude", "Longitude", "Lat", "Lon").
                  </AlertDescription>
                </Alert>
